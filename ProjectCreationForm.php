...
if(isset($_POST['submit'])){
  ...
  if ( isset($_FILES["file"]["type"]) )
  {
    ...
    $destination_directory = "image/project/";
      ...
      if ( $_FILES["file"]["size"] < ($max_size) )
      {
        ...
        else
        {
          ...
          else
          {
            ...
            $targetPath = $destination_directory . $title;
  ...
  require('dbconn.php');
  $query = "INSERT INTO users VALUES($title, $description, $start_date, $end_date, $project_id,
